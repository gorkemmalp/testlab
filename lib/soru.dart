...
class _SoruViewState extends State<SoruView> {
  ...
  void setMatCount(int _matTrue, int _matFalse, int _matTotal) async {
    final prefsMat = await SharedPreferences.getInstance();

    prefsMat.setInt("MATTRUE", _matTrue);
    prefsMat.setInt("MATFALSE", _matFalse);
    prefsMat.setInt("MATTOTAL", _matTotal);

    getMatCount();
  }

  void getMatCount() async {
    final prefsMat = await SharedPreferences.getInstance();

    int setMatTrue = prefsMat.getInt("MATTRUE");
    int setMatFalse = prefsMat.getInt("MATFALSE");
    int setMatTotal = prefsMat.getInt("MATTOTAL");

    if (setMatTrue == null) setMatTrue = 0;
    if (setMatFalse == null) setMatFalse = 0;
    if (setMatTotal == null) setMatTotal = 0;

    setState(() {
      matTrue = setMatTrue;
      matFalse = setMatFalse;
      matTotal = setMatTotal;
    });
  }
    ...
    FirebaseFirestore.instance
      ...
      setState(() {
        ...
        if (!asked) {
          getMatCount();
          matTotal++;
          setMatCount(matTrue, matFalse, matTotal);
          questionText = incomingQuestion.data()['soru'];
          aText = incomingQuestion.data()['a'];
          bText = incomingQuestion.data()['b'];
          cText = incomingQuestion.data()['c'];
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                height: 60,
                                margin:
                                    EdgeInsets.fromLTRB(1, 15, 15, 20), //LTRB
                                child: MaterialButton(
                                  onPressed: () {
                                    answerControl = "Cevap: A";
                                    askControl();
                              ...
                              Container(
                                ...
                                height: 60,
                                margin:
                                    EdgeInsets.fromLTRB(1, 20, 15, 1), //LTRB
                                child: MaterialButton(
                                  onPressed: () {
                                    answerControl = "Cevap: C";
                                    askControl();
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                height: 60,
                                margin:
                                    EdgeInsets.fromLTRB(15, 15, 1, 20), //LTRB
                                child: MaterialButton(
                                  onPressed: () {
                                    answerControl = "Cevap: B";
                                    askControl();
                              ...
                              Container(
                                ...
                                height: 60,
                                margin:
                                    EdgeInsets.fromLTRB(15, 20, 1, 1), //LTRB
                                child: MaterialButton(
                                  onPressed: () {
                                    answerControl = "Cevap: D";
                                    askControl();
